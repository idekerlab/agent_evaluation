...
object_specifications = {
    ...
    # MARK:judgement_space
    "judgement_space": {
        "documentation": "A JudgementSpace enables the comparison and analysis of a group of human reviewers and Reviewer agents. The analysis is based on an ordered list of ReviewSet objects, each containing Reviews generated by the reviewer group.",
        # "actions": ["create_analysis_run"],
        "properties": {
            "name": {
                "type": "string",
