...
class Analyst(AE_Object):
    def __init__(self, db, llm, context, prompt_template, name, description, persist=False, get=False):
        ...
        :type db: Database
        :param llm: The LLM object representing the language model used for generating hypotheses.
        :type llm: LLM
        :param context: The context used for the LLM to generate queries.
        :type context: str
        :param prompt_template: A template used when querying the LLM to generate hypotheses.
